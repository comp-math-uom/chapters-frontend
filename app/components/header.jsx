            ...
            <div className="w-full mt-8 flex justify-center items-center">
                <div className="relative w-full max-w-7xl">
                    <input
                        type="text"
                        placeholder=""
                        className="w-full py-3 pl-10 pr-12 border-2 border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                    <div className="absolute left-3 top-1/2 tramsform -translate-y-1/2 text-gray-400">
                        <svg className="feather feather-search h-10 w-10" fill="none"  stroke="#bcbcbc" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="relative w-1/12 h-10 flex items-center justify-center">
                    <button className="h-full w-auto" onClick={ handleToggleFilter }>
                        <Image src={filterIcon} alt="Filter Icon" className="h-12 w-auto"/>
                    </button>
                </div>
            </div>
            {showText && (
                <div className="w-full mt-8 flex items-center justify-center text-lg text-gray-500">
                    <div className="relative w-full mx-auto max-w-[92%]">
                        <ul className="flex flex-wrap gap-2 list-none justify-between">
                            <li className="w-full relative flex flex-[0_0_20%] items-center border-2 border-gray-300 rounded-xl px-4">
                                <div onClick={() => setYearOpen(!YearOpen)}
                                     className="px-4 py-2 cursor-pointer justify-between flex items-center">
                                    <Image src={ArrowDown} alt="Arrow Down" className="mr-2 border-gray-300"/>
                                    Year
                                </div>
                                {YearOpen && (
                                    <div
                                        ...
                                        <ul aria-orientation="vertical" className="py-2">
                                            <li className="px-4 py-2 hover:bg-gray-300">2022</li>
                                            <li className="px-4 py-2 hover:bg-gray-300">2023</li>
                                            <li className="px-4 py-2 hover:bg-gray-300">2024</li>
                                            <li className="px-4 py-2 hover:bg-gray-300">2025</li>
                                        </ul>
                                    </div>
                                )}
                            </li>
                            <li className="w-full relative flex flex-[0_0_20%] items-center border-2 border-gray-300 rounded-xl px-4">
                                <div onClick={() => setBatchOpen(!BatchOpen)}
                                     className="px-4 py-2 cursor-pointer justify-between flex items-center">
                            ...
                            <li className="w-full relative flex flex-[0_0_20%] items-center border-2 border-gray-300 rounded-xl px-4">
                                <div onClick={() => setMonthOpen(!MonthOpen)}
                                     className="px-4 py-2 cursor-pointer justify-between flex items-center">
                                    <Image src={ArrowDown} alt="Arrow Down" className="mr-2"/>
                                    Month
                                </div>
                            ...
                            <li className="w-full relative flex flex-[0_0_20%] items-center border-2 border-gray-300 rounded-xl px-4">
                                <div onClick={() => setFeildOpen(!FieldOpen)}
                                     className="px-4 py-2 cursor-pointer justify-between flex items-center">
                                    <Image src={ArrowDown} alt="Arrow Down" className="mr-2"/>
                                    Feild
                                </div>
                            ...
                            <li className="w-full flex flex-[0_0_17%] justify-center">
                                <button
                                    className="cursor-pointer flex flex-[0_0_100%] justify-center border-2 border-gray-200 rounded-xl px-12 py-4 bg-gray-200">
                                    Filter
                                </button>
                            </li>
                        </ul>
